...
class patient extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->helper('fidelius');
        $this->load->helper('timestmp');
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
           ...
           //Link care context
            ...
            $ava_no = $this->input->post('ava_no');
            $ava_adds = $this->input->post('ava_adds');

       $tok = $this->avha_create->linkTokenget($ava_adds);
      ...
      if($tok->link_token != ''){
        ...
        $timestamp = $datetime->format('Y-m-d\TH:i:s.') . sprintf('%03d', $datetime->format('v')) . 'Z';
         ...
         $sess_token = $this->abha_session_gen_m2();
       
          //echo $uuid.''.$timestamp;
        $reqid = rand(10000000,99999999);
        $refId = 'TMH-PUID-'.$reqid;

        $curl = curl_init();
        curl_setopt_array($curl, array(
          CURLOPT_URL => 'https://dev.abdm.gov.in/api/hiecm/hip/v3/link/carecontext',
       ...
       $httpCode = curl_getinfo($curl, CURLINFO_HTTP_CODE);
        if($httpCode == '202'){
        $this->avha_create->linkcarecontextstatusUpdate($ava_adds);
        }
       }
 ...
 */
    ...
    public function patientDetails()
    {
        ...
        $result['avha_no']      =  $result['avha_no'];
        $result['avha_address']  = $result['avha_address'];
        $result['avha_no1']      =  $result['avha_no'];
        $result['avha_address1']  = $result['avha_address'];
    ...
    {
       $tdata = timestampUid();
       $pdata = $this->prescripTionfhirbundle($timestamp,$uuid);
...
private function prescripTionfhirbundle($timestamp,$uuid){
   $pdata = '{
    "resourceType": "Bundle",
    "id": "FHIR163",
    "meta": {
        "versionId": "1",
        "lastUpdated": "2024-10-09T07:03:32.696Z",
        "profile": [
    ...
    "type": "document",
    "timestamp": "2024-11-16T06:35:27.694Z",
    "entry": [
        {
            ...
            "resource": {
                ...
                "text": {
                    "status": "generated",
                    "div": <div xmlns="http:\/\/www.w3.org\/1999\/xhtml">Prescription Record<\/div>"
                },
                "identifier": {
                ...
                "subject": {
                    ...
                    "display": " Lavkush Kumar"
                },
                "encounter": {
                    "reference": "Encounter\/FHIR163",
                    "display": " Lavkush Kumar"
                },
                "date": "2024-10-09T07:03:32.696Z",
                "author": [
                    {
                        "reference": "Practitioner\/1",
                        "display": "Dr. ZEESHAN KHAN"
                    }
                ],
                ...
                "identifier": [
                    {
                        ...
                        "system": "https:\/\/nhpr.abdm.gov.in",
                        "value": "71085334025876"
                    }
                ],
                "name": [
                    {
                        "text": "Dr. ZEESHAN KHAN"
                    }
                ]
            }
        },
        ...
        },
        {
            ...
            "resource": {
                ...
                "period": {
                    "start": "2024-10-09T07:03:32.696Z"
                }
            }
        },
        [
            {
                ...
                "resource": {
                    ...
                    "text": {
                        "status": "generated",
                        "div": "<div xmlns="http:\/\/www.w3.org\/1999\/xhtml">Generated Narrative with Details MedicationRequest <\/div>"
                    },
                    "status": "active",
                    "intent": "order",
                    "medicationCodeableConcept": {
                        "coding": {
                            "system": "http:\/\/snomed.info\/sct",
                            "code": "384977007",
                            "display": "DOXCEF 200MG TABLET Drug : Cefpodoxime 200 MG"
                        }
                    },
                    "subject": {
                        "reference": "Patient\/23",
                    ...
                    "reasonCode": {
                        "coding": {
                            "system": "http:\/\/snomed.info\/sct",
                            "code": "386661006",
                            "display": "FEVER WITH RASH "
                        }
                    },
                    "dosageInstruction": {
                        "text": "(Dosage: 1-0-1) Instruction:  with milk",
                        "route": {
                            "coding": {
                                "system": "http:\/\/snomed.info\/sct",
                                "code": "26643006",
...
return $pdata;
 ...
 private function abha_session_gen_m2(){
   $datetime = new DateTime('now', new DateTimeZone('UTC'));
  $timestamp = $datetime->format('Y-m-d\TH:i:s.') . sprintf('%03d', $datetime->format('v')) . 'Z';
