            ...
            <div class="topaleart">
                <div class="slidealert">
                    <div class="alert alert-dismissible topaleart-inside">
                        <p class="palert">Alert! You are using unregistered version of Medulia Hospital. Please <a  href="#" class="purchasemodal">click here</a> to register your purchase code for Medulia Hospital.</p>
                    </div>
                </div>
            </div>
            <?php
