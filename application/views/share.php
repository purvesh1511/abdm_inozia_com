...
if (isset($share_data->share_date) && strtotime(date('Y-m-d')) >= strtotime($share_data->share_date) && (IsNullOrEmptyString($share_data->valid_upto) || (!IsNullOrEmptyString($share_data->valid_upto) && strtotime(date('Y-m-d')) <= strtotime($share_data->valid_upto)))) {
    ...
    ?>
                                <h3 class="font-bold"><?php echo $share_data->title; ?></h3>
                                <div class="row ptt10 pb10">
                                    <div class="col-md-4 col-lg-4 col-sm-12">
                                <p><b><?php echo $this->lang->line('upload_date'); ?></b> : <?php echo $this->customlib->YYYYMMDDTodateFormat($share_data->share_date); ?></p>
                                    </div>
                                    <div class="col-md-4 col-lg-4 col-sm-12">
                                <p><b><?php echo $this->lang->line('valid_upto'); ?></b> : <?php echo $this->customlib->YYYYMMDDTodateFormat($share_data->valid_upto);  ?></p>

                                    </div>
                                    <div class="col-md-4 col-lg-4 col-sm-12">

                                <p><b><?php echo $this->lang->line('shared_by'); ?></b> : <?php echo $share_data->name.' '.$share_data->surname.' ('.$share_data->employee_id.")";
    ?></p>
                                    </div>
                                </div>
                                <div class="row">
...
<?php
        ...
        foreach ($share_data->upload_contents as $content_key => $content_value) {
            ...
            ?>
 <li class="list-group-item" data-style="button" style="cursor: pointer; display: flex; align-items: center;">
...
<?php
    ...
    ?>
   <h1 class="font-white bolds mb0 font-bold"><?php echo $this->lang->line('this_link_is_invalid_or_expired'); ?>  </h1>
                                          <?php
