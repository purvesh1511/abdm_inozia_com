                    ...
                    <div class="row" id="patient_details"></div>
                        ...
                        <div class="row">
                            <div class="col-md-offset-6 col-xs-6">
                                ...
                                <form action="<?php echo base_url(); ?>patient/payment/skrill/pay" method="post" >
                                ...
                                <div class="table-responsive">
                                    ...
                                    <?php } ?>
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-primary submit_button"><i class="fa fa fa-money"></i> <?php echo $this->lang->line('pay_with_skrill') ?></button>
                                        </div> 
                                </form>
                            </div>
                        </div>
