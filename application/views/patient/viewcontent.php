...
<div class="row"> 
    <div class="col-lg-4 col-md-4 col-sm-4"><label><?php echo $this->lang->line('upload_date'); ?></label> :  <?php echo $this->customlib->YYYYMMDDTodateFormat($content->share_date, $timeformat); ?></div>
    <div class="col-lg-4 col-md-4 col-sm-4"><label><?php echo $this->lang->line('valid_upto'); ?></label> :  <?php echo $this->customlib->YYYYMMDDTodateFormat($content->valid_upto, $timeformat); ?></div>
    ...
    <div class="col-md-3">
        <p><label><?php echo $this->lang->line('share_date'); ?></label>: <?php echo $this->customlib->YYYYMMDDTodateFormat($content->share_date, $timeformat); ?></p>
    </div>
</div>
<div class="row">
