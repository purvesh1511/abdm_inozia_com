...
<div class="row">
    <div class="col-md-9">
        ...
        <div class="row">
            <div class="col-md-4">
                <p><label><?php echo $this->lang->line('upload_date'); ?></label>: <?php echo $this->customlib->YYYYMMDDTodateFormat($shared_contents->share_date);?></p>  
            </div>
            <?php 
...
?>
 <div class="col-md-4">                 
                <p><label><?php echo $this->lang->line('valid_upto'); ?></label>: <?php echo $this->customlib->YYYYMMDDTodateFormat($shared_contents->valid_upto);?></p>
            </div>
<?php
}
             ?>
               ...
               <div class="col-md-4">             
                <p><label><?php echo $this->lang->line('share_date'); ?></label>: <?php echo $this->customlib->YYYYMMDDTodateFormat($shared_contents->share_date);?></p>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 ptt10">
                <h4 class="box-title bmedium font16"><?php echo $this->lang->line('attachments'); ?></h4>  
