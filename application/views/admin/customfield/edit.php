                                                        ...
                                                        foreach ($records_fields as $records_fields_key => $records_fields_value) {
                                                            ...
                                                            <li id="<?php echo $records_fields_value['id']; ?>" class="list-group-item-sort">
                                                                <span class="sort-action sort-pull-right">
                                                                    ...
                                                                    <a onclick = "return confirm('<?php echo $this->lang->line('delete_confirm'); ?>')" href="<?php echo site_url('admin/customfield/delete/' . $records_fields_value['id']); ?>" class="btn btn-xs" data-toggle="tooltip"
