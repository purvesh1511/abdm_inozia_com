...
if ($this->rbac->hasPrivilege('banner_images', 'can_view')) {
        ...
        if ($this->rbac->hasPrivilege('banner_images', 'can_delete')) {
            ?>
                                                        <div class='overlay3'>
                                                            <a href='#' title="<?php echo $this->lang->line('delete'); ?>"  class='uploadclosebtn delete_gallery_img' data-record_id='<?php echo $banner_image_value->id ?>' data-toggle='modal' data-target='#confirm-delete'><i class=' fa fa-trash-o'></i></a>
