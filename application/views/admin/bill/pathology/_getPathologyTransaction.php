     ...
     <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
            <table class="table table-hover table-sm">
                ...
                <tr>                   
                    <td class="text-right"><label><?php echo $this->lang->line('total_discount'); ?><?php if (!empty($pathology_billing->discount)) {
                            echo " (".$pathology_billing->discount_percentage."%) ";  }  ?></label></td>
                    <td class="text-right">
                        <?php if (!empty($pathology_billing->discount)) {
                            echo $currency_symbol.$pathology_billing->discount;
                       }  ?>                           
                    </td>
                </tr>                
                 <tr>
