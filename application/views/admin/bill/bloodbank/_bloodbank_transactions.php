    ...
    ?>  <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-8">
                <table class="table table-hover table-sm">                           
                    ...
                    <tr>
                        ...
                        <td width="85%" colspan="3"><?php echo $blood_issue_detail['organisation_name']?></td>
                    </tr>
                    <tr>
                        <th width="15%"><?php echo $this->lang->line('tpa_id'); ?></th>
                        <td width="85%" colspan="3"><?php if(isset($blood_issue_detail['insurance_id'])==true){ echo $blood_issue_detail['insurance_id'];}  ?> </td>
                    </tr>
                    <tr>
                        <th width="15%"><?php echo $this->lang->line('tpa_validity'); ?></th>
                        <td width="85%" colspan="3"><?php if(isset($blood_issue_detail['insurance_validity'])==true){ echo $this->customlib->YYYYMMDDTodateFormat($blood_issue_detail['insurance_validity']);}  ?></td>
                    </tr>                
                </table>
            </div>    
            <div class="col-lg-4 col-md-4 col-sm-4">
                <table class="table table-hover table-sm">
                    ...
                    <tr>     
                        <th><?php echo $this->lang->line('discount'); ?> <?php echo "(".$blood_issue_detail['discount_percentage'].") ";?></th>
                        <td class="text text-right"> <?php $discount_amount	=	calculatePercent($blood_issue_detail['amount'],$blood_issue_detail['discount_percentage']);			
						echo $currency_symbol.$discount_amount; ?></td>
                    </tr>
                    <tr>
                        <th><?php echo $this->lang->line('tax'); ?> <?php echo "(".$blood_issue_detail['tax_percentage'].") "?></th>
						<td class="text text-right">
							<?php  
								$final_amount = $blood_issue_detail['amount']-$discount_amount;					
								echo $currency_symbol.calculatePercent($final_amount,$blood_issue_detail['tax_percentage']);					
							?>
                        </td>
                    </tr> 
                    <tr>                   
...
<?php } ?>
    ...
    ?>
   <tr><td colspan="6"><span class="req text-center"><?php echo $this->lang->line("no_record_found")?></span></td></tr>
    <?php
}
         ?>
    </tbody>
