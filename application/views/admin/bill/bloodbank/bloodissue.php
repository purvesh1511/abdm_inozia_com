            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('blood_issue_billing'); ?></h3>
                    ...
                    <div class="box-body">
                        <div class="download_label"><?php echo $this->lang->line('blood_issue_billing'); ?></div>
                        <table class="table table-striped table-bordered table-hover ajaxlist" width="100%" data-export-title="<?php echo $this->lang->line('blood_issue_billing'); ?>">
                            <thead>
                                <tr>  
...
<div class="modal fade ddd" id="addPaymentModal" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog pup100" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close pupclose" title="<?php echo $this->lang->line('close'); ?>" data-dismiss="modal">&times;</button>           
            ...
            <div class="modal-header modal-media-header">
                ...
                <div class="modalicon">
                    <div id='edit_deletebill'>
                        <a href="#" data-target="#edit_prescription" data-toggle="modal" data-original-title="<?php echo $this->lang->line('edit'); ?>"><i class="fa fa-pencil"></i></a>
...
$('#myModal,#addPaymentModal,#viewModal,#addPaymentModal').modal({
    ...
    show:false
      ...
      var $this = $(this);
       $this.button('loading');
      $.ajax({
          url: base_url+'admin/bill/allotblood',
          type: "POST",
          dataType: 'json',
           beforeSend: function() {
              $this.button('loading');
...
<script type="text/javascript">
   ...
   $("#formadd").on('submit', (function (e) {           
            ...
            $.ajax({
                 url: base_url+'admin/bill/save_blood_issue',
                type: "POST",
                data: postData,
                dataType: 'json',
                contentType: false,
...
( function ( $ ) {
    ...
    $(document).ready(function () {
        initDatatable('ajaxlist','admin/bill/getbloodissueDatatable',[],[],100,
                        [
