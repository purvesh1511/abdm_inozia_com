                        ...
                        <div class="row">    
                            <div class="col-sm-2 col-xs-4 col20">
                                <div class="form-group">
                                    ...
                                    <input name="bleeding" class="form-control" id="bleeding" type="text" class="form-control" />
                                </div>
                            </div> 
                            <div class="col-sm-2 col-xs-4 col20">
                                <div class="form-group">
                                    <label for="pwd"><?php echo $this->lang->line('headache'); ?></label> 
                                    <input name="headache" class="form-control" id="headache" type="text" class="form-control" />
                                </div>
                            </div>
                            <div class="col-sm-2 col-xs-4 col20">
                                <div class="form-group">
                                    <label for="pwd"><?php echo $this->lang->line('pain'); ?></label> 
                                    <input name="pain" class="form-control" id="pain" type="text" class="form-control" />
                                </div>
                            </div>
                            <div class="col-sm-2 col-xs-4 col20">
                                <div class="form-group">
                                    <label for="pwd"><?php echo $this->lang->line('constipation'); ?></label> 
                                    <input name="constipation" class="form-control" id="constipation" type="text" class="form-control" />
                                </div>
                            </div>
                            <div class="col-sm-2 col-xs-4 col20">
                                <div class="form-group">
                                    <label for="pwd"><?php echo $this->lang->line('urinary_symptoms'); ?></label> 
                                    <input name="urinary_symptoms" class="form-control" id="urinary_symptoms" type="text" class="form-control" />
                                </div>
                            </div>                            
                        </div><!--./col-md-12-->
                        <div class="row"> 
                            <div class="col-sm-2 col-xs-4 col20">
                                <div class="form-group">
                                    ...
                                    <input name="vomiting" class="form-control" id="vomiting" type="text" class="form-control" />
                                </div>
                            </div>
                            <div class="col-sm-2 col-xs-4 col20">
                                <div class="form-group">
                                    <label for="pwd"><?php echo $this->lang->line('cough'); ?></label> 
                                    <input name="cough" class="form-control" id="cough" type="text" class="form-control" />
                                </div>
                            </div>
                            <div class="col-sm-2 col-xs-4 col20">
                                <div class="form-group">
                                    <label for="pwd"><?php echo $this->lang->line('vaginal'); ?></label> 
                                    <input name="vaginal" class="form-control" id="vaginal" type="text" class="form-control" />
                                </div>
                            </div>
                            <div class="col-sm-2 col-xs-4 col20">
                                <div class="form-group">
                                    <label for="pwd"><?php echo $this->lang->line('discharge'); ?></label> 
                                    <input name="discharge" class="form-control" id="discharge" type="text" class="form-control" />
                                </div>
                            </div>
                            <div class="col-sm-2 col-xs-4 col20">
                                <div class="form-group">
                                    <label for="pwd"><?php echo $this->lang->line('height'); ?></label> 
                                    <input name="height" class="form-control" id="height" type="text" class="form-control" />
                                </div>
                            </div>                            
                        </div><!--./col-md-12-->
                        <div class="row"> 
