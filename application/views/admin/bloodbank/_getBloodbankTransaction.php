            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                <table class="table table-hover table-sm">
                    ...
                    <tr>
                        ...
                        <td><?php if($blood_issue_detail['date_of_issue']){ echo $this->customlib->YYYYMMDDTodateFormat($blood_issue_detail['date_of_issue']) ; }?></td>
                    </tr>
                    <tr>    
...
<?php } ?>
    ...
    ?>
   <tr><td colspan="6" class="text-center"> <center class="req"><?php echo $this->lang->line("no_record_found")?></center></td></tr>
    <?php
}
         ?>
    </tbody>
