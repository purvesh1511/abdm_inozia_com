        ...
        <div class="col-md-8">            
            <table class="table table-striped table-hover">                        
				...
				<tr>
                    ...
                    <td width="35%"><?php if(isset($result['insurance_id'])==true){ echo $result['insurance_id'];}  ?></td>                
                    <th width="15%"><?php echo $this->lang->line('tpa_validity'); ?></th>
                    <td width="35%"><?php if(isset($result['insurance_validity'])==true){ echo $this->customlib->YYYYMMDDTodateFormat($result['insurance_validity']);}  ?></td>
                </tr>				
                <tr>
        ...
        <div class="col-md-12">
			<table class="table table-striped table-hover">   
				...
				<tr>
                    ...
                    <td width="75%"><?php echo $result[$fields_value->name]; ?></td>
                </tr>
				<?php 
						}
                    }  ?>			
