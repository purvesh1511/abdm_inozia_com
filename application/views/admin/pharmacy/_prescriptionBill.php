                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <option value=""><?php echo $this->lang->line('select') ?></option>
										...
										<a class="btn btn-info addplus-xs add-record mb10" data-added="0"><i class="glyphicon glyphicon-plus"></i>&nbsp;<?php echo $this->lang->line('add'); ?></a>									
                                    </div>
                                    <div class="divider"></div>
                                        ...
                                        <div class="col-sm-6">
                                            <table class="printablea4">
                                                ...
                                                <input type="text" placeholder="<?php echo $this->lang->line('discount'); ?>" name="discount_percent" id="discount_percent" class="form-control discount_percent" style="width: 70%; float: right;font-size: 12px;"/></td>
                                                    ...
                                                    <td class="text-right ipdbilltable">
                                        <input type="text" placeholder="<?php echo $this->lang->line('discount'); ?>" value="0" name="discount" onkeyup="get_percentage(this.value)"  id="discount" style="width: 50%; float: right" class="form-control discount"/></td>
                                                </tr>
                                                <tr>
                                                    <th><?php echo $this->lang->line('tax') . " (" . $currency_symbol . ")"; ?></th>
                                                    <td class="text-right ipdbilltable">
