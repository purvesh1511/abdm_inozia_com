    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">  
                ...
                <div class="alert alert-danger">
                    Medulia Hospital may not work properly because ONLY_FULL_GROUP_BY is enabled, consult with your hosting provider to disable ONLY_FULL_GROUP_BY in sql_mode configuration.
                </div>
            <?php } 
                $show=false;
