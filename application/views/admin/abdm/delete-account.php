            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix">Delete ABHA</h3>
                    ...
                    <div class="box-body">
                        <form action="<?php echo base_url(); ?>admin/abhavalidation/deleteAccount" method="POST">
							...
							<div class="mb-15 mt-15" id="reasonDiv" style="display:none">
        					  <!--label for="abha_data" id="methodText">ABHA Number:</label-->
        					  <input type="text" class="form-control" id="abha_reason" placeholder="Reason for deletion"  name="deactivation_reason">
        					</div>
