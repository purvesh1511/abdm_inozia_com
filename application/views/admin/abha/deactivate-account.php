            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix">Deactivate ABHA</h3>
                        <div class="box-tools pull-right">
                            <a href="<?php echo base_url(); ?>admin/abhavalidation/abhaprofile" class="btn btn-primary btn-sm"> Profile</a> 
                        </div>    
                    </div>
                    
                    <div class="box-body">
                        <form action="<?php echo base_url(); ?>admin/abhavalidation/deactivateAccount" method="POST">
							...
							<div class="form-check mb-15 mt-15">
                                ...
                                <label class="radio-inline">
                                  <input type="radio"  type="radio" onclick="selectVerificationMethod(this.value)" name="verify_by" value="aadhar_otp"> Using Aadhar OTP
                                </label>
                                
                                <label class="radio-inline">
                                  <input type="radio" type="radio" onclick="selectVerificationMethod(this.value)" name="verify_by" value="password"> Using Password
                                </label>
							...
							<div class="mb-15 mt-15" id="reasonDiv" style="display:none">
        					  <!--label for="abha_data" id="methodText">ABHA Number:</label-->
        					  <input type="text" class="form-control" id="abha_reason" placeholder="Reason for deactivation"  name="deactivation_reason">
        					</div>
 ...
 function selectVerificationMethod(vl)
 {
     switch(vl)
     {
         case "abha_otp":
             ...
             document.getElementById("abha_data").value = "<?php echo $this->session->userdata('userAbhaNumber')?>";
         ...
         case "password":
             ...
             document.getElementById("abha_reason").required = true;
