                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <a onclick="addModal()" class="btn btn-primary btn-sm addsource"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('add_source'); ?></a>
                            <?php }?>
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
    ...
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content mx-2">
            <div class="modal-header modal-media-header overflow-hidden">
                ...
                <form id="form_add_multiple" action="<?php echo site_url('admin/source/add_multiple_source') ?>"  class="ptt10"  method="post" accept-charset="utf-8">
                                    ...
                                    <table class="table table-striped mb0 table-bordered table-hover  tablefull12 tblProducts " id="tableID_vitals">
                                        <thead>
                                            <tr class="font13 white-space-nowrap">
                                                <th width="30"><?php echo $this->lang->line('source'); ?><small class="req" style="color:red;"> *</small></th>
