            ...
            <div class="col-md-8"> 
                <div class="nav-tabs-custom">
                   ...
                   <ul class="nav nav-tabs navlistscroll">
                        ...
                        <li><a href="#tab_4" data-toggle="tab"><?php echo $this->lang->line('mollie'); ?></a></li>
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-7">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-md-5 col-sm-5 col-xs-12" for="exampleInputEmail1">
                            ...
                            <form role="form" id="mollie" action="<?php echo site_url('admin/paymentsettings/mollie') ?>" class="form-horizontal" method="post">
                                ...
                                <div class="box-footer">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            <?php if ($this->rbac->hasPrivilege('payment_methods', 'can_edit')) { ?>
                                                <button type="submit" class="btn btn-primary mollie_save" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('save'); ?>"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                                            <?php } ?>
                                        </div>
                                    </div>        
                                </div>
                            ...
                            <form role="form" id="cashfree" action="<?php echo site_url('admin/paymentsettings/cashfree') ?>" class="form-horizontal" method="post">
                                ...
                                <div class="box-footer">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            <?php if ($this->rbac->hasPrivilege('payment_methods', 'can_edit')) { ?>
                                                <button type="submit" class="btn btn-primary cashfree_save" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('save'); ?>"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                                            <?php } ?>
                                        </div>
                                    </div>        
                                </div>
                            ...
                            <form role="form" id="payfast" action="<?php echo site_url('admin/paymentsettings/payfast') ?>" class="form-horizontal" method="post">
                                ...
                                <div class="box-footer">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            <?php if ($this->rbac->hasPrivilege('payment_methods', 'can_edit')) { ?>
                                                <button type="submit" class="btn btn-primary payfast_save" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('save'); ?>"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                                            <?php } ?>
                                        </div>
                                    </div>        
                                </div>
                            ...
                            <form role="form" id="toyyibpay" action="<?php echo site_url('admin/paymentsettings/toyyibPay') ?>" class="form-horizontal" method="post">
                                ...
                                <div class="box-footer">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            <?php if ($this->rbac->hasPrivilege('payment_methods', 'can_edit')) { ?>
                                                <button type="submit" class="btn btn-primary toyyibpay_save" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('save'); ?>"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                                            <?php } ?>
                                        </div>
                                    </div>        
                                </div>
...
?>
                                ...
                                <div class="box-footer">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            <?php if ($this->rbac->hasPrivilege('payment_methods', 'can_edit')) {?>
                                                <button type="submit" class="btn btn-primary sslcommerz_save" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('save'); ?>"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                                            <?php }?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="box-body">
                            <div class="form-group"> <!-- Radio group !-->
                                ...
                                <div class="form-check">
                                    ...
                                    <?php echo $this->lang->line('razorpay'); ?></label>
                                </div>                                
								<div class="form-check">
                                    <label class="form-check-label">
                                    ...
                                    <?php echo $this->lang->line('paytm'); ?></label>
                                </div>                              
                                <div class="form-check">
                                    <label class="form-check-label">
                                    ...
                                    <?php echo $this->lang->line('midtrans'); ?></label>
                                </div>                                
                                <div class="form-check">
                                    <label class="form-check-label">
                                    ...
                                    <?php echo $this->lang->line('pesapal'); ?></label>
                                </div> 
                                <div class="form-check">
                                    <label class="form-check-label">
                                    ...
                                    <?php echo $this->lang->line('flutter_wave'); ?></label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                    ...
                                    <?php echo $this->lang->line('ipay_africa'); ?></label>
                                </div>                                    
                                <div class="form-check">
                                    <label class="form-check-label">
                                   ...
                                   <?php echo $this->lang->line('jazzcash'); ?></label>
                                </div>                            
                                ...
                                <div class="form-check">
                                    ...
                                    <?php echo $this->lang->line('billplz'); ?></label>
                                </div>                           
                                <div class="form-check">
                                    <label class="form-check-label">
                                    ...
                                    <?php echo $this->lang->line('sslcommerz'); ?></label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio"  class="form-check-input" name="payment_setting" value="payhere" <?php
...
?>>
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio"  class="form-check-input" name="payment_setting" value="onepay" <?php
...
?>>
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="payment_setting" value="mollie" <?php
                                        if ($radio_check == 'mollie') {
                                            echo "checked";
                                        }
                                        ?>>
                                        
                                   <?php echo $this->lang->line('mollie'); ?></label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="payment_setting" value="cashfree" <?php
                                        if ($radio_check == 'cashfree') {
                                            echo "checked";
                                        }
                                        ?>>
                                        
                                    <?php echo $this->lang->line('cashfree'); ?></label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="payment_setting" value="payfast" <?php
                                        if ($radio_check == 'payfast') {
                                            echo "checked";
                                        }
                                        ?>>
                                        
                                   <?php echo $this->lang->line('payfast'); ?></label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="payment_setting" value="toyyibpay" <?php
                                        if ($radio_check == 'toyyibpay') {
                                            echo "checked";
                                        }
                                        ?>>
                                        
                                    <?php echo $this->lang->line('toyyibpay'); ?></label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="payment_setting" value="twocheckout" <?php
                                        if ($radio_check == 'twocheckout') {
                                            echo "checked";
                                        }
                                        ?>>
                                        
                                   <?php echo $this->lang->line('twocheckout'); ?></label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="payment_setting" value="skrill" <?php
                                        if ($radio_check == 'skrill') {
                                            echo "checked";
                                        }
                                        ?>>
                                        
                                    <?php echo $this->lang->line('skrill'); ?></label>
                                </div>
