        ...
        <div class="col-lg-8 col-md-8 col-sm-8">
           <table class="table table-hover table-sm">
            ...
            <tr>    
                ...
                <td><?php if(isset($radio_billing->organisation_name)==true){ echo $radio_billing->organisation_name ; } ?></td>
            </tr>
            <tr>    
                <td><label><?php echo $this->lang->line('tpa_id'); ?></label></td>
                <td><?php if(isset($radio_billing->insurance_id)==true){ echo $radio_billing->insurance_id;}  ?></td>
            </tr>
            <tr>    
                <td><label><?php echo $this->lang->line('tpa_validity'); ?></label></td>
                <td><?php if(isset($radio_billing->insurance_validity)==true){ echo $this->customlib->YYYYMMDDTodateFormat($radio_billing->insurance_validity);}  ?></td>
            </tr>
            <?php  $balance_amount = $radio_billing->net_amount -  $radio_billing->total_deposit;  ?>
         </table>
      </div>   
