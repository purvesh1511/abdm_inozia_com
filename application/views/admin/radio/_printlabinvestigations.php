                ...
                <div class="card-body">  
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">                             
                            <p><span class="text-muted"><?php echo $this->lang->line('approve_date'); ?>: </span> <?php if(isset($result->parameter_update)){echo $this->customlib->YYYYMMDDTodateFormat($result->parameter_update); } ?></p>   
                            <p><span class="text-muted"><?php echo $this->lang->line('report_collection_date'); ?>: </span> <?php if(isset($result->collection_date)) { echo $this->customlib->YYYYMMDDTodateFormat($result->collection_date);} ?></p>
                            <p><span class="text-muted"><?php echo $this->lang->line('expected_date'); ?>: </span> <?php if(isset($result->reporting_date)){ echo $this->customlib->YYYYMMDDTodateFormat($result->reporting_date);} ?></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <table class="print-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left"><?php echo ($level_exceeded)? "<span class='text-danger'>".$parameter_value->radiology_report_value." ".$parameter_value->unit_name."</span>":"<span>".$parameter_value->radiology_report_value." ".$parameter_value->unit_name."</span>";  ?> </td>
                                    ...
                                    <tr> 
                                        ...
                                        echo $this->lang->line('result'); ?>: </b> <?php echo nl2br($parameter_value->radiology_result); ?></p></td>
                                    </tr>                             
                                    <?php
                                    }
                                    ?>                             
