...
class Paymentsettings extends Admin_Controller
{
    ...
    public function mollie() {
     ...
     public function cashfree() {
        ...
        $this->form_validation->set_error_delimiters('', '');
        $this->form_validation->set_rules('cashfree_app_id', ('App ID --r'), 'trim|required|xss_clean');
     ...
     public function payfast() {
        ...
        $this->form_validation->set_rules('payfast_salt', ('security_passphrase --r'), 'trim|required|xss_clean');
        if ($this->form_validation->run()) {
    ...
    public function toyyibPay() {
        ...
        $this->form_validation->set_error_delimiters('', '');
        $this->form_validation->set_rules('toyyibpay_api_secret_key', ('Secret Key --r'), 'trim|required|xss_clean');
        $this->form_validation->set_rules('toyyibpay_category_code', 'category_code --r', 'trim|required|xss_clean');
        if ($this->form_validation->run()) {
     ...
     public function skrill() {
        ...
        $this->form_validation->set_error_delimiters('', '');
        $this->form_validation->set_rules('skrill_api_email', ('Merchant Account Email --r'), 'trim|required|xss_clean');
        $this->form_validation->set_rules('skrill_salt', 'Merchant Secret Salt --r', 'trim|required|xss_clean');
        if ($this->form_validation->run()) {
    ...
    public function twocheckout() {
        ...
        $this->form_validation->set_error_delimiters('', '');
        $this->form_validation->set_rules('twocheckout_api_publishable_key', 'Merchant Code --r', 'trim|required|xss_clean');
        $this->form_validation->set_rules('twocheckout_api_secret_key', 'Secret Key --r', 'trim|required|xss_clean');
        if ($this->form_validation->run()) {
            $data = array(
