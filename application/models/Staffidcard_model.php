...
class Staffidcard_model extends MY_model {
    ...
    public function addstaffidcard($data) {
        ...
        if (isset($data['id'])) {
			...
			$message      = UPDATE_RECORD_CONSTANT." On Staff id card id ".$data['id'];
			$action       = "Update";
			$record_id    = $data['id'];
			...
			$message      = INSERT_RECORD_CONSTANT." On Staff id card id ".$insert_id;
			$action       = "Insert";
			$record_id    = $insert_id;
			$this->log($message, $record_id, $action);
			//======================Code End==============================
    ...
    public function remove($id) {
		...
		$message      = DELETE_RECORD_CONSTANT." On staff id card id ".$id;
        $action       = "Delete";
        $record_id    = $id;
        $this->log($message, $record_id, $action);
		//======================Code End==============================
