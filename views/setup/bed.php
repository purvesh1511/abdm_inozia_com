            ...
            <form id="addbed" class="ptt10" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                <div class="modal-body pt0 pb0">
                        <div class="row" id="edit_bedtypedata">
                            ...
                            <input type="checkbox" name="mark_as_unused" > <?php echo $this->lang->line('not_available_for_use'); ?></label>
                ...
                <div class="modal-body pt0 pb0">
                    <div class="row" id="edit_bedtypedata">
                        ...
                        <div class="col-sm-12">
                                <div class="form-group">                                   
                                  <label class="checkbox-inline">
                            <input id="mark_as_unused" type="checkbox" name="mark_as_unused" > <?php echo $this->lang->line('not_available_for_use'); ?></label>
                                </div>
                            </div>
                    </div>
                </div>
