                ...
                <div class="nav-tabs-custom relative">                   
                    <ul class="nav nav-tabs border-0 navlistscroll">
                        ...
                        <?php } if ($this->rbac->hasPrivilege('opd_charges', 'can_view')) { ?>
                            <li><a href="#charges" data-toggle="tab" aria-expanded="true"><i class="fas fa-donate"></i> <?php echo $this->lang->line('charges'); ?></a></li>
                        <?php } if ($this->rbac->hasPrivilege('opd_payment', 'can_view')) {     ?>
                            <li><a href="#payment" data-toggle="tab" aria-expanded="true"><i class="fas fa-hand-holding-usd"></i> <?php echo $this->lang->line('payments'); ?></a></li>
                        ...
                        <li><a href="#vitals" data-toggle="tab" aria-expanded="true"><i class="fa fa-blood-pressure">&#xf21e;</i> <?php echo $this->lang->line('vitals'); ?></a></li>
                        <?php }?>                        
                    </ul>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 border-r">
                                    <div class="box-header border-b mb10 pl-0 pt0">
                                        <h3 class="text-uppercase bolds mt0 ptt10 rtl-float-right float-left font14"><?php echo composePatientName($result['patient_name'],$result['patient_id']); ?></h3>
                                        <div class="pull-right">
                                            <div class="editviewdelete-icon pt8 text-center">
                                                <?php if ($this->rbac->hasPrivilege('opd_patient', 'can_edit')) { ?>
                                                    <a href="#" onclick="editRecord('<?php echo $visitminid; ?>')" data-target="#editModal" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('edit'); ?>"><i class="fa fa-pencil"></i></a>
                                                <?php } ?>
                                                <?php if ($this->rbac->hasPrivilege('opd_patient', 'can_delete')) { ?>
                                                    <a class="" href="#" onclick="delete_patient('<?php echo $result['id'] ?>','<?php echo $result['patient_id'] ?>')"   data-toggle="tooltip" title="<?php echo $this->lang->line('delete_patient'); ?>"><i class="fa fa-trash"></i></a>                                                        
                                                <?php } if ($this->rbac->hasPrivilege('opd_patient_discharge', 'can_view')) { ?>
                                                    <a class="patient_discharge" href="#"    data-toggle="tooltip" title="<?php echo $this->lang->line('patient_discharge'); ?>"><i class="fa fa-hospital-o"></i></a> 
                                                <?php } if(!$is_discharge){
                                                    if ($this->rbac->hasPrivilege('opd_patient_discharge_revert', 'can_view')) { ?>
                                                     <a data-toggle="tooltip"  onclick="discharge_revert('<?php echo $result['case_reference_id']; ?>')" href="#" title="<?php echo $this->lang->line('discharge_revert')?>"><i class="fa fa-undo"> </i></a>
                                                    <?php
                                                } } ?>
                                    ...
                                    <div class="row">
                                                   ...
                                                   <tr>
                                                    ...
                                                    <tr>
                                                        <td class="bolds"><?php echo $this->lang->line('tpa_id'); ?></td>
                                                         <td><?php if(isset($result['insurance_id'])){ echo $result['insurance_id'];} ?></td>
                                                    </tr>                                                       
                                                    <tr>
                                                        <td class="bolds"><?php echo $this->lang->line('tpa_validity'); ?></td>
                                                         <td><?php if(isset($result['insurance_validity'])){echo $this->customlib->YYYYMMDDTodateFormat($result['insurance_validity']);} ?></td>
                                                    </tr>                                                   
                                                     <?php
                                                    if (file_exists("./uploads/patient_id_card/barcodes/" . $id . ".png")) { ?>
                                                   <tr>
                                                        <td class="bolds"><?php echo $this->lang->line('barcode'); ?></td>
                                                        <td><a href="<?php echo $this->media_storage->getImageURL('uploads/patient_id_card/barcodes/' . $id . '.png'); ?>" target="_blank"><img src="<?php echo base_url("./uploads/patient_id_card/barcodes/" . $id . ".png"); ?>" width="100" height="30" /></a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                    <?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="<?php echo $this->media_storage->getImageURL('uploads/patient_id_card/qrcode/' . $id . '.png'); ?>" target="_blank"><img class="h-50" src="<?php echo base_url("./uploads/patient_id_card/qrcode/" . $id . ".png"); ?>"  width="70" height="70"  /></a></td>
                                                    </tr>   
                                                    <?php }  ?>                                                       
                                                </table>
                                            </div><!--./col-lg-7-->
                                        ...
                                        <?php } ?>                                        
                                    <hr class="hr-panel-heading hr-10">
                                    <p><b><i class="fa fa-tag rtl-ms-0-7-5"></i> <?php echo $this->lang->line('known_allergies'); ?>:</b></p>
                                    <ul>  
                                    <?php 
                                    ...
                                    <hr class="hr-panel-heading hr-10">
                                    <p><b><i class="fa fa-tag rtl-ms-0-7-5"></i> <?php echo $this->lang->line('findings'); ?>:</b></p>  
                                    <ul>
                                    <?php 
                                    ...
                                    <hr class="hr-panel-heading hr-10">
                                    <p><b><i class="fa fa-tag rtl-ms-0-7-5"></i> <?php echo $this->lang->line('symptoms'); ?>:</b></p> 
                                     <ul> 
                                    ...
                                    <div class="box-header mb10 pl-0">
                                        <h3 class="text-uppercase bolds mt0 ptt10 rtl-float-right float-left font14"><?php echo $this->lang->line('consultant_doctor'); ?></h3>
                                        <div class="pull-right">
                                 ...
                                 <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="row">
                                         ...
                                         <div class="box-header mb10 pl-0">
                                           <h3 class="text-uppercase bolds mt0 ptt10 rtl-float-right float-left font14"><?php echo $this->lang->line('medication'); ?></h3>
                                           <div class="pull-right">
                                          </div>
                                        </div>
                                        <div class="box-header mb10 pl-0">
                                        ...
                                        <!---lab investigation-->
                                        <div class="box-header mb10 pl-0">
                                           <h3 class="text-uppercase bolds mt0 ptt10 rtl-float-right float-left font14"><?php echo $this->lang->line('lab_investigation'); ?></h3>
                                           <div class="pull-right">                                               
                                          </div>
                                        </div>
                                         <div class="box-header mb10 pl-0">
                                        ...
                                        <div class="box-header mb10 pl-0">
                                           <h3 class="text-uppercase bolds mt0 ptt10 rtl-float-right float-left font14"><?php echo $this->lang->line('operation'); ?></h3>
                                           <div class="pull-right">                                               
                                          </div>
                                        </div>
                                         <div class="box-header mb10 pl-0">
                                     ...
                                     <table class="table table-striped table-bordered table-hover" data-export-title="<?php echo $this->lang->line('operations'); ?>">
                                        ...
                                        <!---consultant section-->                                       
                                         <div class="box-header mb10 pl-0">
                                           <h3 class="text-uppercase bolds mt0 ptt10 rtl-float-right float-left font14"><?php echo $this->lang->line('charges'); ?></h3>
                                           <div class="pull-right">                                               
                                          </div>
                                        </div>
                                         <div class="box-header mb10 pl-0">
                                        ...
                                        <div class="box-header mb10 pl-0">
                                           <h3 class="text-uppercase bolds mt0 ptt10 rtl-float-right float-left font14"><?php echo $this->lang->line('payment'); ?></h3>
                                           <div class="pull-right">                                               
                                          </div>
                                        </div>
                                         <div class="box-header mb10 pl-0">
                                    ...
                                    if($payment['cheque_date']!='' && $payment['cheque_date']!='0000-00-00'){
                                       echo $this->lang->line('cheque_date') .": ".$this->customlib->YYYYMMDDTodateFormat($payment['cheque_date']);
                                        ...
                                        <div class="box-header mb10 pl-0">
                                           <h3 class="text-uppercase bolds mt0 ptt10 rtl-float-right float-left font14"><?php echo $this->lang->line('live_consultation'); ?></h3>
                                           <div class="pull-right">
                                          ...
                                          for ($x = 0; $x <= $dosage_count; $x++){
                                            if (array_key_exists($x,$mvalue['dose_list']))
                                                ...
                                                <?php if ($this->rbac->hasPrivilege('opd_medication', 'can_add')) {
                                                    if($is_discharge){
                                                 ?>
                                                    <a href="#" class="btn btn-sm btn-primary dropdown-toggle addmedication" onclick="medicationModal('<?php echo $medicine_category_id;?>','<?php echo $medicine_id ;?>','<?php echo $date;?>')" data-toggle='modal'><i class="fa fa-plus"></i></a>
                                                <?php }} ?>
                                                    <?php
                                                  } 
                                                  ?></td>
    ...
    <a href='javascript:void(0);' class='btn btn-default btn-xs edit_charge' data-loading-text='<?php echo $this->lang->line('please_wait') ;?>' data-toggle='tooltip' data-record-id='<?php echo $charges_value['id']; ?>'  title="<?php echo  $this->lang->line('edit')?>"><i class='fa fa-pencil'></i></a>
                        ...
                        <a href="javascript:void(0);" onclick="deleteOpdPatientCharge('<?php echo $charges_value['id']; ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title=""  data-original-title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash"></i></a>
                                        ...
                                        <tr class="box box-solid total-bg">
                                            <td colspan='11' class="text-right"><?php echo $this->lang->line('total') . " : " . $currency_symbol . "" . amountFormat($total); ?> 
                                                    ...
                                                    <div class="timeline-item">                                                
                                                        <?php if ($this->rbac->hasPrivilege('opd_timeline', 'can_delete')) { 
                                                             if ($value['generated_users_type'] != 'patient') {
                                                                if($is_discharge){
                                                            ?>
                                                            <span class="time"><a class="defaults-c text-right btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="delete_timeline('<?php echo $value['id']; ?>')" data-original-title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash"></i></a></span>
                                                        <?php }} } ?>
                                                        <?php if (!empty($value["document"])) { ?>       
        
                                                            <span class="time"><a class="defaults-c text-right btn btn-default btn-xs" data-toggle="tooltip" title="" href="<?php echo base_url() . "admin/timeline/download_patient_timeline/" . $value["id"] . "/" . $value["document"] ?>" data-original-title="<?php echo $this->lang->line('download'); ?>"><i class="fa fa-download"></i></a></span>
                                                            
                                                            <span class="time"><a target="_blank" class="defaults-c text-right btn btn-default btn-xs" data-toggle="tooltip" title="" href="<?php echo base_url() . "uploads/patient_timeline/" . $value["document"] ?>" data-original-title="<?php echo $this->lang->line('view'); ?>"><i class="fa fa-reorder"></i></a></span>
                     ...
                     <div class="col-lg-1 col-md-5 col-sm-11">
                      <div class="form-check pt5 pb-sm-5">
                        ...
                        <label class="form-check-label text-white" for="">
                          <?php echo $this->lang->line('apply_tpa'); ?> </label>
                    </div> 
                    </div>
                    <div class="col-lg-1 col-md-5 col-sm-11">
                                ...
                                <div class="row ptt10">                                   
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly name="schedule_charge" id="editscd_charge" placeholder="" class="form-control schedule_charge" value="<?php echo set_value('schedule_charge'); ?>">    
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">                           
                                ...
                                <div class="row ptt10">                             
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label><?php echo $this->lang->line('tpa_charge') . " (" . $currency_symbol . ")" ?></label>
                                            <input type="text" readonly name="schedule_charge" id="addscd_charge" placeholder="" class="form-control reset_value schedule_charge" value="<?php echo set_value('schedule_charge'); ?>">    
                                            <span class="text-danger"><?php echo form_error('schedule_charge'); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8 ptt10">
                                        <div class="row">
                                                <div class="col-lg-9 col-md-9 col-sm-9">
                                                    <ul class="singlelist">
                                                        <li class="singlelist24bold"><span id="patientname"></span></li>
                                                        <li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                             ...
                                             <div class="form-check pt5">
                                              ...
                                              <input type="hidden" name="organisation" id="revisit_organisation" value="<?php echo $result['id'];?>">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label><?php echo $this->lang->line('applied_charge') . " (" . $currency_symbol . ")" ?></label><small class="req"> *</small><input type="text" name="amount" id="apply_chargevisit"  class="form-control apply_charge">    
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label ><?php echo $this->lang->line('amount'); ?> <?php echo '(' . $currency_symbol . ')'; ?></label><small class="req"> *</small> 
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label ><?php echo $this->lang->line('paid_amount'); ?> <?php echo '(' . $currency_symbol . ')'; ?></label><small class="req"> *</small>
       ...
       var $this = $(this);
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#edit_delete').html("<?php if ($this->rbac->hasPrivilege('visit', 'can_edit')) { ?><a href='#'' onclick='editRecord(" + visitid + ")' data-target='#editModal' data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa fa-pencil'></i></a><?php } ?><?php if ($this->rbac->hasPrivilege('visit', 'can_delete')) { ?>"+delete_action+"<?php } ?>" );
