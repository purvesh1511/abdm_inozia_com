                  ...
                  <div class="box-header ptbnull"></div>
                    ...
                    <div class="box border0 clear">
                        ...
                        <div class="box-body table-responsive">
                            <div class="download_label"><?php echo $this->lang->line('ipd_discharged_patient_report'); ?></div>
                            <table class="table table-striped table-bordered table-hover allajaxlist" cellspacing="0" width="100%" data-export-title="<?php echo $this->lang->line('ipd_discharged_patient_report'); ?>">
                                <thead>
                                    <tr>
