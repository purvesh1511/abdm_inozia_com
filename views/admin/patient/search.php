                ...
                <div class="modal-body pt0 pb0">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">                            
                                ...
                                <input type="hidden" name="ava_no" id="ava_no1" class="form-control" />
                                <input type="hidden" name="ava_adds" id="ava_adds1"  class="form-control" />   
                                ...
                                <div class="row row-eq h-vh-lg-100-100">
                                    ...
                                    <option value=""><?php echo $this->lang->line('select')?></option>
                                        ...
                                        <?php  } ?>
                                         ...
                                         <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label>HiP Type</label>
                                                    <select name="hip_type"  class="form-control">
                                                           <option value="">Select Hip type</option>
           ...
           $.ajax({
            ...
            success: function (res) {
                ...
                if (res) {
                    ...
                    $("#ava_no").html(res.avha_no);
                    $("#ava_adds").html(res.avha_address);
                    $("#ava_no1").val(res.avha_no);
                    $("#ava_adds1").val(res.avha_address);
