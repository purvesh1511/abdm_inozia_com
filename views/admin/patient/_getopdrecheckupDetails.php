        ...
        <div class="table-responsive">
            <table class="table mb0 table-striped table-bordered examples tablelr0space noborder">
                ...
                <tr>  
                    ...
                    <td width="35%"><span id="age"><?php echo $this->customlib->getPatientAge($result['age'],$result['month'],$result['day'])." (".$this->lang->line('as_of_date').' '.$this->customlib->YYYYMMDDTodateFormat($result['as_of_date']).")"; ?></span></td>
                ...
                <tr>
                    ...
                    <td width="50%"><span id='symptoms'><?php if($result['symptoms']){ echo nl2br($result['symptoms']); } ?></span></td>    
                </tr> 
                <?php  if (!empty($fields)) {
