        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form action="<?php echo base_url(); ?>admin/abhavalidation/verifyDeactivateOtp" method="POST">
                           ...
                           <div class="mb-15 mt-15" id="reasonDiv">
        					  ...
        					  <input type="text" class="form-control" id="abha_reason" placeholder="Reason for deactivation"  name="deactivation_reason" required>
        					</div>
