                ...
                <article class="card card-product-list">
                    <div>
                        ...
                        <?php if ($content_value->file_type == 'xls' || $content_value->file_type == 'xlsx') {  ?>                 
                            <img class='p-4' src="<?php echo $this->media_storage->getImageURL('backend/images/excelicon.png'); ?>">
                            
                        <?php } elseif ($content_value->file_type == 'ppt' || $content_value->file_type == 'pptx') {   ?>
                        
                            <img class='p-4' src="<?php echo $this->media_storage->getImageURL('backend/images/pptxicon.png'); ?>">
                        
                        <?php } elseif ($content_value->file_type == 'doc' || $content_value->file_type == 'docx') {  ?>
                        
                            <img class='p-4' src="<?php echo $this->media_storage->getImageURL('backend/images/wordicon.png'); ?>">
                        
                        <?php } elseif ($content_value->file_type == "csv") {   ?>
                        
                            <img class='p-4' src="<?php echo $this->media_storage->getImageURL('backend/images/txticon.png'); ?>">
                            
                        <?php } elseif ($content_value->file_type == "pdf") {   ?>
                        
                            <img class='p-4' src="<?php echo $this->media_storage->getImageURL('backend/images/pdficon.png'); ?>">
                        ...
                        <?php } elseif ($content_value->file_type == "zip" || $content_value->file_type == "rar") {   ?>
                            ...
                            <img class='p-4' src="<?php echo $this->media_storage->getImageURL('backend/images/zipicon.png'); ?>">
                        ...
                        <?php } elseif ( $content_value->file_type == '3g2' || $content_value->file_type == '3gp' || $content_value->file_type == 'mp4'  || $content_value->file_type == 'm4a' || $content_value->file_type == 'f4v' || $content_value->file_type == 'flv' || $content_value->file_type == 'webm') {  ?>
                            ...
                            <img class='p-4' src="<?php echo $this->media_storage->getImageURL('backend/images/video-icon.png'); ?>">
                            
                        <?php }else { ?>
                        
                            <img class='p-4' src="<?php echo $this->media_storage->getImageURL('backend/images/docsicon.png'); ?>">
         ...
         <table class="table table-bordered table_contents">
            <thead>
                <tr>
                    ...
                    <th class="text-right text-rtl-left"><?php echo $this->lang->line('created_on'); ?></th>    
                </tr>
            </thead>
            <tbody>
                <?php
