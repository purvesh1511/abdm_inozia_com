							...
							<div class="col-lg-6 col-md-6 col-sm-8 col-xs-8">
								<form method="POST" action="#" id="searchform">
									<div class="input-group input-group-sm">
										...
										<button type="submit" class="btn btn-default  post_search_submit border-1 border-color-light"><i class="fa fa-search"></i></button>
										</div>
									</div>
								</form>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="documents_sidebar">
										<div class="d-preview text-center p-4">
										...
										<div class="documents_sidebar_info p-4">
											...
											<div class="sidebar-form-content displaynone">
												...
												<form class="pt20" action="<?php echo site_url('admin/content/ajaxupdate'); ?>" method="POST" id="side_form">
													...
													<button type="submit" class="btn btn-sm btn-primary pull-right"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
													<div class="clearfix"></div>
												</form>
											</div>
										</div>
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" id="load" data-loading-text="<i class='fa fa-spinner fa-spin'></i> <?php echo $this->lang->line('saving'); ?>"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                </div>
            </div>
        </form>
    </div>
...
<div id="shareURLModal" class="modal fade" role="dialog">
 ...
 <div class="row">
  ...
  <button type="submit" class="btn btn-primary btn-sm" id="load" data-loading-text="<i class='fa fa-spinner fa-spin'></i> <?php echo $this->lang->line('saving'); ?>"><?php echo $this->lang->line('generate_url'); ?></button>
 </div>
