...
<input type="hidden" name="prev_reports[]" value="<?php echo  $report_value->id;?>">
 ...
 <input type="hidden" name="inserted_id_<?php echo $total_rows;?>" value="<?php echo  $report_value->id;?>">
                                                <select class="form-control test_name select2" style="width:100%" name='test_name_<?php echo $total_rows;?>'>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div>
        <select name='consultant_doctor' id="consultant_doctor" onchange="get_Docname(this.value)" class="form-control select2" style="width:100%">
                                    ...
                                    <div class="col-sm-6">
                                        <table class="printablea4">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right ipdbilltable">
													<input type="text" placeholder="Discount" onkeyup="get_percentage(this.value)" value="<?php echo $radiology_data->discount; ?>" name="discount" id="discount" style="width: 50%; float: right" class="form-control discount"/></td>
                                            </tr>
                                            <tr>
