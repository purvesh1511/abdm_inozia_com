...
<html lang="en">
    <head>
        ...
        <style type="text/css">
            ...
            .form-bottom {box-shadow: 0px 0px 30px rgba(0, 0, 0, 0.35); padding-bottom: 15px !important}
                            ...
                            <div class="loginbg">
                                <div class="form-top">
                                    <div class="form-top-left pt-20">
                                        <h3 class="font-white mb-0 mt-0"><?php echo $this->lang->line('forgot_password'); ?></h3>
