                ...
                <div class="paddtop20">
                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg">
                            ...
                            <form action="<?php echo base_url(); ?>patient/onlineappointment/toyyibpay/pay" method="post">
                                    <table class="table2" width="100%">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td  bgcolor="#fff" class="text-right"> <button type="submit"  name="search"  value="" class="btn btn-info"><?php echo $this->lang->line("pay_with_toyyibpay"); ?> <i class="fa fa fa-chevron-right"></i></button></td>
                                        </tr>
                                    </table>
