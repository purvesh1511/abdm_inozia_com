          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="col-md-6 text-right">
                <p><span class="text-muted font-bold"><?php echo $this->lang->line("date"); ?>: </span> <?php if ($result->created_at) {
                                                                                                          echo $this->customlib->YYYYMMDDTodateFormat($result->created_at);
                                                                                                        } ?></p>
                <p><span class="text-muted font-bold"><?php echo $this->lang->line("collection_date"); ?>: </span> <?php if ($result->collection_date) {
                                                                                                                      echo $this->customlib->YYYYMMDDTodateFormat($result->collection_date);
                                                                                                                    } ?></p>
              </div>
            </div>
          </div>
                    ...
                    ?>
                      <tr class="<?php echo $row_cls; ?>">
                        ...
                        <td class="text-left">
                          ...
                          <div class="bill_item_footer text-muted"><label><?php if ($parameter_value->description != '') {
                                                                            echo $this->lang->line('description') . ': ';
                                                                          } ?></label> <?php echo $parameter_value->description; ?></div>
                        </td>
                        <td class="text-left">
