                    ...
                    <div class="row">
                            ...
                            <table class="print-table">
                             <thead>
                                <tr class="line">
                                   ...
                                   <td class="text-left"><?php echo $this->lang->line("date"); ?></td>
                      ...
                      $tax_amt=0;
                        ...
                        <tr>
                                ...
                                <td class="text-left"><?php echo  $this->customlib->YYYYMMDDTodateFormat($report_value->reporting_date); ?></td>
                                <td class="text-left"><?php echo $currency_symbol.''.$tax_amt." (".$report_value->tax_percentage."%)"; ?></td>
                    ...
                    $row_counter++;
                        ...
                        ?> 
                                ...
                                <tr>
                                   ...
                                   <td class="text-right no-line"><?php echo $currency_symbol . "" . amountFormat($result->discount); ?></td>
                                </tr>
                                <tr>
                                   <td colspan="3" class="no-line"></td>
                                ...
                                <tr>
                                  ...
                                  <tr>
                                   ...
                                   <td class="text-right no-line"><?php echo $currency_symbol . "" . amountFormat($amount+$tax_amt-$result->total_deposit-$result->discount); ?></td>
                                </tr>
                             </tbody>
                          </table>
                        </div>
